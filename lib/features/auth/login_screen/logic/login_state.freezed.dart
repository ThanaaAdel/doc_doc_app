...
class __$$LogoutImplCopyWithImpl<T, $Res>
    extends _$LoginStateCopyWithImpl<T, $Res, _$LogoutImpl<T>>
...
class _$LogoutImpl<T> implements Logout<T> {
  const _$LogoutImpl();

  @override
  String toString() {
    return 'LoginState<$T>.logout()';
  }
...
abstract class Logout<T> implements LoginState<T> {
